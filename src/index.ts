...
export class MyMCP extends McpAgent {
    ...
    async init() {
        const env = this.env as unknown as PhewasEnv;
        registerVariantLookup(this.server);
